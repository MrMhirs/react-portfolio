      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="font-burtons text-xl">developedbyrob</h1>
          ...
          <div className="text-center p-10 py-10">
            <h2 className="text-5xl py-2 text-red-600 font-medium dark:text-teal-400 md:text-6xl">
              Robert Baguena
            </h2>
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              I offer i wide range of services, including programming,
              tech-support and designing.
            </p>
          </div>
        ...
        <section className="py-10">
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              Since the beginning of my journey as a developer i mainly focus on
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              I offer from a wide range of services, including designing,
